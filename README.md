# Computer Science BS Degree Proposal
...
The proposed degree emphasizes **enduring CS abstractions** (algorithms, systems, data, AI, ethics) rather than short-lived tools, ensuring graduates remain adaptable over 10–15 years as technologies evolve. Total degree hours: **74 credits**.
...
- **[draft_justification.md](math-classes/draft_justification.md)** — Rationale for data- and computing-oriented math requirements (physics removed)

#### [impact-on-existing-courses/](impact-on-existing-courses/)
Analysis of how the proposal affects current course offerings:
- **224-324/** — CS 224/324 course transition details
...
## Major Changes from Existing Degree

| Aspect | Change |
|--------|--------|
| **Structure** | Split into CS Foundations → Junior Core → Breadth/Depth/Capstone |
| **AI Coverage** | Now **required** in junior core (previously elective) |
| **Databases** | Now **required** in junior core (previously elective) |
| **Breadth** | **Explicit requirement** across 4 areas (previously implicit) |
| **Depth** | **Explicit 400-level requirement** (previously optional) |
| **Experiential Learning** | **Required capstone/internship/research** (previously optional) |
| **Math/Physics** | Physics removed; focus on **data-oriented analytics** |
| **Philosophy** | Emphasis on **abstractions and paradigms** for 10–15 year adaptability |
